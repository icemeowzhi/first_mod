...
public class GreenAppleBoots extends ItemArmor implements ISpecialArmor {

    public static final String REGISTRY_NAME = "green_apple_boots";
    public static Item item = new GreenAppleBoots(GreenApple.materialArmor,0,EntityEquipmentSlot.FEET);
    public GreenAppleBoots(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
